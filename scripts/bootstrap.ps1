...
# 用法：irm https://raw.githubusercontent.com/vinnfeng/opencode-config/main/scripts/bootstrap.ps1 | iex
$ErrorActionPreference = 'Stop'

$Branch  = if ($env:OPENCODE_BRANCH) { $env:OPENCODE_BRANCH } else { 'main' }
