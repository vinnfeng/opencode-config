...
**前置：** [Node.js 18+](https://nodejs.org) · [Git](https://git-scm.com) · Mify API Key（[点这里申请，公司内网登录即可](https://llm.mioffice.cn/apikey)）
...
脚本会自动检测已有 Mify 配置；检测不到会提示你填，填一次以后不再问。
...
- 🤖 接入 Mify：一个 Key 路由 Claude / GPT / Gemini / DeepSeek / Kimi
...
- Mify-OpenAI：GPT-5.4 Pro / GPT-5.4 / O3 / O4 Mini
- Mify-Google：Gemini 3.1 Pro / Flash
- Mify-Zhipu：GLM-5
- Mify-DeepSeek：DeepSeek V3.2 / R1
- Mify-Kimi：Kimi K2.5
...
*Community branch — 仅需 Mify Key，无其他依赖*
